...
path_video_face = 'Project\\SIC_Project\\Face recognition data\\Dataset' # đường dẫn tới folder video
# path_frame = 'Project\\SIC_Project\\Data\\NewData' # đường dẫn tới folder ảnh cắt từ video
path_frame_face = 'Project\\SIC_Project\\Face recognition data\\NewData' # đường dẫn tới ảnh sau khi cắt từ frame
